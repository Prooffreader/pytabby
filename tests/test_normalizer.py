...
class TestCaseInsensitive:
    ...
    def test_header_entry_changed(self, config_multiple, random_string):
        ...
        normal = normalizer.normalize(c)
        if normal['tabs'][0]['header_entry'] == random_string or normal['tabs'][0]['header_entry'] != random_string.lower():
            raise AssertionError
    ...
    def test_valid_entries_changed(self, config_all_with_id, random_string):
        ...
        normal = normalizer.normalize(c)
        if (normal['tabs'][0]['items'][0]['valid_entries'][0] == random_string or
            normal['tabs'][0]['items'][0]['valid_entries'][0] != random_string.lower()):
            raise AssertionError